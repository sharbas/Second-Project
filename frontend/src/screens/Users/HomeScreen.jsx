...
const HomeScreen = () => {
  ...
  {/* Banner 1 */}
  <Link to="http://localhost:3000/places?category=Solo&&packageId=6544dfbc0fe7d68bdad9edf8" style={{ textDecoration: 'none' }} className="block">
  ...
  {/* Banner 3 */}
   <Link to="http://localhost:3000/places?category=Honeymoon&&packageId=6544e4260fe7d68bdad9ee05" style={{ textDecoration: 'none' }} className="block">
  <div className="bg-white p-4 rounded-md shadow-md overflow-hidden hover:transform hover:scale-105 transition-transform">
