                    ...
                    <img
                      src={
                        client.clientPhoto
                          ...
                          : `https://travelwithwetravel.website/images/${client.clientPhoto}`
                      }
                    ...
                    <img
                      src={
                        client.passportFrontPhoto
                          ...
                          : `https://travelwithwetravel.website/images/${client.passportFrontPhoto}`
                      }
                      className="w-full h-full rounded-lg"
                      alt={[]}
                    />
                    ...
                    <img
                      src={
                        client.passportBackPhoto
                          ...
                          : `https://travelwithwetravel.website/images/${client.passportBackPhoto}`
                      }
                      className="w-full h-full rounded-lg"
                      alt={[]}
                    />
