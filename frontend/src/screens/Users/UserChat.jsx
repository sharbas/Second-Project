...
const ENDPOINT = "https://travelwithwetravel.website";
...
const UserChat = () => {
  ...
  const sendHandler = async () => {
    ...
    try {
      let res = await userAxiosInstance.post(`/sendchat/${chatId}/User`, {
        content,
      });
      if (res) {
        setContent("");
  ...
  useEffect(() => {
    let fetchMessages = async () => {
      let res = await userAxiosInstance.get(`/get-room-messages/${chatId}`);
      if (res) {
        setChats(res.data);
  ...
  useEffect(() => {
    if (userInfo) {
      let fetchRooms = async () => {
        let res = await userAxiosInstance.get("/getrooms");
        setRooms(res.data);
      };
      fetchRooms();
    }
