...
console.log(formDataToSend,'thisi is formdatatosend');
    try{
      const res=await axios.put('https://travelwithwetravel.website/api/admin/updatePackage',formDataToSend, {
        headers: {
        ...
        <tbody>
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-2">
              ...
              <img src=  {`https://travelwithwetravel.website/images/${selectedPackage.categoryImages}`} alt="" />
              </div>
            </td>
          </tr>
          <tr>
